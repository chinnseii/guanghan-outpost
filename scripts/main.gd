...
func _load_game() -> void:
	...
	if _dev_tools != null:
		_dev_tools.call("set_menu_visible", false)
...
func _setup_main_menu() -> void:
	...
	_dev_tools = DevToolsControllerScript.new()
	_dev_tools.name = "DevToolsController"
	add_child(_dev_tools)
	_dev_tools.call("setup", self, $UI/Root)
	_dev_tools.call("build_menu")
