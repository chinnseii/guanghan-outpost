...
## 当前版本：V0.23 机器人电量与任务面板

当前重点是让机器人自动化更像真实劳动力：机器人现在有独立电量，执行任务会耗电，低电会暂停任务并回充电桩；充电期间暂停队列。机器人充电桩会打开任务面板，可查看当前任务、队列、电量、目标地点，并支持取消任务和调整优先级。
...
2. V0.25 引导体验打磨：
   - 增加屏幕边缘目标提示，目标离开视野时仍能找到方向
   - 任务日志支持展开/折叠，并记录长期目标历史
   - 第一次操作加入 UI 遮罩和按钮高亮
3. V0.26 正式素材下一轮：
   - 将气闸、生命维持罐、温室种植床、太阳能板替换为独立 PNG/sprite 资源
