...
- **Pending handoffs**: `0`
- **Branch**: `main`
- **Board baseline**: `fe00d37` (AUI-03-02 close-out commit pending on top of this)
...
- Characterization: existing `_show_appearance()` characterized before editing (see implementation notes below once read).
